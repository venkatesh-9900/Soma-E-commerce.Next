    ...
    return fields.reduce(function (result, field) {
        ...
        if (localPath.every(function (path) { return Array.isArray(path); })) {
            var multiXPaths = localPath
                ...
                .join(' | ');
            return __assign(__assign({}, result), (_a = {}, _a[key] = (0, utility_1.uniq)(toNodeArray((0, xpath_1.select)(multiXPaths, targetDoc)).map(function (n) { return n.nodeValue; }).filter(utility_1.notEmpty)), _a));
        }
        ...
        */
        if (attributes.length === 0) {
            ...
            if (nodes.length > 1) {
                attributeValue = nodes.filter(function (n) { return n.firstChild; })
